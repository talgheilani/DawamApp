    ...
    public class DawamAppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EmployeeStatus>().HasData(
                ...
                new EmployeeStatus { Id = 2, EmployeeName = "Sara", Status = StatusType.Holiday, StartDate = new DateTime(2025, 10, 1), EndDate = new DateTime(2025, 10, 10) },
                ...
                new EmployeeStatus { Id = 4, EmployeeName = "Layla", Status = StatusType.Duty, StartDate = new DateTime(2025, 10, 15), EndDate = new DateTime(2025, 10, 15) },
